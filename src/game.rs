...
use crate::builder::{
    CurveBuilder, Joint2, JointConnection, MovingSplineDot, Segment, SegmentConnection,
};
...
fn test_branch(commands: &mut Commands) {
    ...
    commands.entity(joints[0]).insert(Joint2 {
    ...
    commands.entity(joints[1]).insert(Joint2 {
        connections: vec![JointConnection {
            segments: smallvec![SegmentConnection {
                id: segments[1],
                t: 0.0,
    ...
    commands.entity(joints[2]).insert(Joint2 {
        connections: vec![JointConnection {
            segments: smallvec![SegmentConnection {
                id: segments[2],
                t: 1.0,
    ...
    commands.entity(joints[3]).insert(Joint2 {
        connections: vec![
            JointConnection {
                segments: smallvec![SegmentConnection {
                    id: segments[0],
...
fn test_3_way_curve(commands: &mut Commands) {
    ...
    commands.entity(top_single_joint).insert(Joint2 {
        connections: vec![JointConnection {
            segments: smallvec![SegmentConnection {
                id: top_segment,
                t: 0.0,
    ...
    commands.entity(left_single_joint).insert(Joint2 {
        connections: vec![JointConnection {
            segments: smallvec![SegmentConnection {
                id: left_segment,
                t: 0.0,
    ...
    commands.entity(right_single_joint).insert(Joint2 {
        connections: vec![JointConnection {
            segments: smallvec![SegmentConnection {
                id: right_segment,
                t: 0.0,
    ...
    commands.entity(top_multi_joint).insert(Joint2 {
        connections: vec![
            JointConnection {
                segments: smallvec![SegmentConnection {
                    id: top_segment,
    ...
    commands.entity(left_multi_joint).insert(Joint2 {
        connections: vec![
            JointConnection {
                segments: smallvec![SegmentConnection {
                    id: left_segment,
    ...
    commands.entity(right_multi_joint).insert(Joint2 {
        connections: vec![
            JointConnection {
                segments: smallvec![SegmentConnection {
                    id: right_segment,
...
const CIRCLE: LazyCell<Sprite> = LazyCell::new(|| {
